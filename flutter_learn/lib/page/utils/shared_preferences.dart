              ...
              ButtonBar(
                ...
                children: < Widget > [
                  ...
                  RaisedButton(
                    ...
                    color: Colors.blue,
                    onPressed: () => {
                      SPUtils.getInstance().putString("username", "xuexiang123")
                        .then((result) => {
              ...
              ButtonBar(
                ...
                children: < Widget > [
                  ...
                  RaisedButton(
                    ...
                    onPressed: () => {
                      random = Random().nextInt(100),
                        SPUtils.getInstance().putInt("int_key", random)
                        .then((result) => {
                  ...
                  RaisedButton(
                    ...
                    color: Colors.blue,
                    onPressed: () => {
                      updateResult('获得的数字:' + SPUtils.getInstance().getInt("int_key").toString())
                    },
                  ),
                ],
              ),
